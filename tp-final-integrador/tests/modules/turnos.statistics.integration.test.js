...
describe('GET /api/v1/turnos/estadisticas - Integration Tests', () => {
    ...
    beforeEach(async () => {
        ...
        await pool.execute('INSERT INTO usuarios (id_usuario, documento, apellido, nombres, email, contrasenia, foto_path, rol, activo) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)', [3, '33333333', 'Paciente', 'Uno', 'pac1@test.com', 'hash', '', ROLES.PACIENTE, 1]);
        await pool.execute('INSERT INTO usuarios (id_usuario, documento, apellido, nombres, email, contrasenia, foto_path, rol, activo) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)', [4, '44444444', 'Paciente', 'Dos', 'pac2@test.com', 'hash', '', ROLES.PACIENTE, 1]);
        // 4. Médico
        ...
        await pool.execute('INSERT INTO turnos_reservas (id_turno_reserva, id_medico, id_paciente, id_obra_social, fecha_hora, valor_total, atendido, activo) VALUES (?, ?, ?, ?, DATE_SUB(NOW(), INTERVAL 1 DAY), ?, ?, ?)', [1, 1, 1, 1, 4500.0, 0, 1]);
        await pool.execute('INSERT INTO turnos_reservas (id_turno_reserva, id_medico, id_paciente, id_obra_social, fecha_hora, valor_total, atendido, activo) VALUES (?, ?, ?, ?, DATE_SUB(NOW(), INTERVAL 2 DAY), ?, ?, ?)', [2, 1, 1, 1, 4500.0, 1, 1]);
        await pool.execute('INSERT INTO turnos_reservas (id_turno_reserva, id_medico, id_paciente, id_obra_social, fecha_hora, valor_total, atendido, activo) VALUES (?, ?, ?, ?, DATE_SUB(NOW(), INTERVAL 5 DAY), ?, ?, ?)', [3, 1, 2, 1, 4500.0, 0, 1]);
