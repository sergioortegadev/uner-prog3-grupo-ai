...
export async function seedTestUser() {
    ...
    await pool.execute('INSERT INTO usuarios (id_usuario, documento, apellido, nombres, email, contrasenia, foto_path, rol, activo) VALUES (?, ?, ?, ?, ?, SHA2(?, 256), ?, ?, ?)', [8, '51000111', 'Fernandez', 'Benito', 'ferben@correo.com', 'password123', '', ROLES.ADMIN, 1]);
}
